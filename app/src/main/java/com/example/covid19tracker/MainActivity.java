...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvCases,tvRecovered,tvCritical,tvActive,tvTodaysCases,tvTotalDeaths,tvTodaysDeaths,tvAffectedCountries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("STATISTICS OF WHOLE WORLD");
